...
extension HomeRecommendedCLVCell : UICollectionViewDelegate, UICollectionViewDataSource{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return homeData.listRecommended.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ItemCell", for: indexPath) as! ItemCell
        cell.releaseDate.text = "Update: \(homeData.listRecommended[indexPath.row].time_release)"
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if let parent = self.parentViewController as? HomeViewController{
            ...
            var name = homeData.listRecommended[indexPath.row].url_manga
...
extension HomeRecommendedCLVCell : UICollectionViewDelegateFlowLayout{
